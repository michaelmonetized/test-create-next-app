    ...
    <NarrowContainer className="py-lg prose prose-invert max-w-none">
      ...
      <div className="not-prose my-lg p-md border-2 border-red-500 bg-red-500/20 rounded-lg">
        ...
        <p className="text-red-200 font-medium mb-sm">
          This software is provided <strong>&quot;AS IS&quot;</strong> without any warranty or
          guarantee of any kind.
        </p>
        <ul className="text-red-200 text-sm space-y-1 list-disc list-inside">
          <li>
            <strong>Zero liability</strong> — We are not responsible for any damages, losses, or
            issues
          </li>
          <li>
            <strong>No guarantees</strong> — Service availability, accuracy, or fitness for purpose
            is not guaranteed
          </li>
          <li>
            <strong>We own everything</strong> — All content generated belongs to us; you receive a
            revocable license
          </li>
          <li>
            <strong>Termination at will</strong> — We may terminate your access at any time, for any
            reason
          </li>
        </ul>
      ...
      <section>
        ...
        <p>
          BY ACCESSING, BROWSING, OR USING HUSTLE LAUNCH (&quot;THE SERVICE&quot;), YOU ACKNOWLEDGE
        ...
        <p>
          Your continued use of the Service constitutes ongoing acceptance of these Terms and any
      ...
      <section>
        ...
        <p>
          Subject to your compliance with these Terms, Hustle Launch grants you a limited,
      ...
      <section>
        ...
        <p className="text-lg border-l-4 border-primary pl-4 bg-muted/30 py-2">
          <strong>All content created through Hustle Launch is owned by Hustle Launch.</strong>
        </p>
        <p>
          By using the Service, you grant Hustle Launch a perpetual, irrevocable, worldwide,
          royalty-free, fully sublicensable license to use, reproduce, modify, adapt, publish,
        ...
        <p>
          You are granted a license to use content generated for your account, subject to these
          Terms and our continued authorization. This license may be revoked at any time at our sole
          discretion.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Generate content that is illegal, harmful, threatening, abusive, harassing, defamatory,
      ...
      <section>
        ...
        <p>
          <strong>
            Hustle Launch reserves the right to terminate or suspend your access to the Service at
        ...
        <p>
          Upon termination, your license to use the Service immediately ceases. You will not be
          entitled to any refund of fees paid. We may delete your account and all associated data
          without liability.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Hustle Launch respects intellectual property rights and expects users to do the same. We
          reserve the right to:
        </p>
        <ul>
          <li>Issue DMCA takedown notices for content that infringes our rights</li>
          <li>Remove or disable access to infringing content</li>
          <li>Terminate accounts of repeat infringers</li>
          <li>Pursue legal action for unauthorized use of our intellectual property</li>
        </ul>
        <p>
          If you use content generated through the Service in violation of these Terms, you may be
          subject to DMCA claims and legal action.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          <strong>
            Hustle Launch does not provide any security guarantees beyond the basic protections
            offered by our third-party service providers.
          </strong>{" "}
          We rely on:
        </p>
        <ul>
          <li>
            <a href="https://clerk.com/security" target="_blank" rel="noopener noreferrer">
              Clerk
            </a>{" "}
            - Authentication security
          </li>
          <li>
            <a href="https://vercel.com/security" target="_blank" rel="noopener noreferrer">
              Vercel
            </a>{" "}
          ...
          <li>
            <a href="https://convex.dev/security" target="_blank" rel="noopener noreferrer">
              Convex
            </a>{" "}
            - Database security
          </li>
          <li>
            <a href="https://resend.com/security" target="_blank" rel="noopener noreferrer">
              Resend
            </a>{" "}
            - Email security
          </li>
        ...
        <p>
          You acknowledge that no system is completely secure. We are not responsible for any
          unauthorized access, data breaches, or security incidents. You use the Service at your own
          risk.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL HUSTLE LAUNCH, ITS
          ...
          REGARDLESS OF WHETHER SUCH DAMAGES WERE FORESEEABLE OR WHETHER HUSTLE LAUNCH WAS ADVISED
          OF THE POSSIBILITY OF SUCH DAMAGES.
        </p>
        <p>
          IN NO EVENT SHALL HUSTLE LAUNCH&apos;S TOTAL LIABILITY TO YOU FOR ALL CLAIMS ARISING OUT
          OF OR RELATING TO THE SERVICE EXCEED ONE HUNDRED DOLLARS ($100.00) OR THE AMOUNT YOU PAID
          TO HUSTLE LAUNCH IN THE THIRTY (30) DAYS IMMEDIATELY PRECEDING THE CLAIM, WHICHEVER IS
          LESS.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          You agree to indemnify, defend, and hold harmless Hustle Launch and its officers,
      ...
      <section>
        ...
        <p>
          Hustle Launch reserves the right to modify these Terms at any time without prior notice.
          Changes become effective immediately upon posting to the Service. Your continued use of
          the Service after any modifications constitutes acceptance of the updated Terms. It is
      ...
      <section>
        ...
        <p>
          Hustle Launch reserves the right to modify, suspend, or discontinue the Service (or any
          part thereof) at any time, with or without notice. We shall not be liable to you or any
      ...
      <section>
        ...
        <p>
          <strong>
            Exclusive jurisdiction and venue for any disputes arising under these Terms shall be in
            the state and federal courts located in Jackson County, North Carolina, USA.
          </strong>{" "}
          You hereby consent to the personal jurisdiction of such courts and waive any objection to
          venue therein.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          <strong>CLASS ACTION WAIVER:</strong> YOU AGREE THAT ANY CLAIMS MUST BE BROUGHT IN YOUR
      ...
      <section>
        ...
        <p>
          These Terms constitute the entire agreement between you and Hustle Launch regarding the
